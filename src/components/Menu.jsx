        ...
        <nav className="navbar navbar-expand-lg">
          ...
          <div className="navbar-collapse collapse show" id="navbarNav">
            <ul className="navbar-nav">
              <MenuItem to="home" {...{ offset, onClick: toggle }}>
                Home
              </MenuItem>
              <MenuItem to="profile" {...{ offset, onClick: toggle }}>
                Profile
              </MenuItem>
              <MenuItem to="experience" {...{ offset, onClick: toggle }}>
                Experience
              </MenuItem>
              <MenuItem to="skills" {...{ offset, onClick: toggle }}>
                Skills
              </MenuItem>
              <MenuItem to="contact" {...{ offset, onClick: toggle }}>
                Contact
              </MenuItem>
            </ul>
          </div>
